...
<model ref="r:c9d846b5-c087-4d75-8ecc-eac4ebf539b9(org.campagnelab.logger.actions)">
  ...
  <imports>
    <import index="whle" ref="r:8e4fd1b7-1955-43a4-ace6-aaf9d13814f8(org.campagnelab.logger.structure)" implicit="true" />
                ...
                <node concept="37vLTI" id="_OOZD5olkl" role="3clFbG">
                  ...
                  <node concept="2OqwBi" id="_OOZD5okHB" role="37vLTJ">
                    ...
                    <node concept="3TrEf2" id="_OOZD5okVA" role="2OqNvi">
                      <ref role="3Tt5mk" to="whle:5T5HpHOBfTm" resolve="node" />
                    </node>
                  </node>
                </node>
              </node>
